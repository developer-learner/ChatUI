...
**Name:** ChatUI
**What it does:** Pending product specification — instructions to be provided.
**Status:** Planning
...
Framework:    [TBD — to be defined with product spec]
Database:     TBD
Auth:         TBD
Hosting:      TBD
...
|------|---------|-------------|
| _date_ | _what went wrong_ | _guard added_ |
