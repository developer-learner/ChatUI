...
`ChatUI` was instantiated from the `sw-dev-blueprint` GitHub template, which provides the complete
...
```
https://github.com/developer-learner/sw-dev-blueprint (template origin)
```
